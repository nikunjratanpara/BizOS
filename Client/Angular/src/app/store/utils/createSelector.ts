import { Selector, MemoizedSelector } from "./MemoizedSelector";
import { createSelectorFactory } from './createSelectorFactory';
import { defaultMemoize } from './defaultMemoize';
export function createSelector<State, S1, Result>(s1: Selector<State, S1>, projector: (S1: S1) => Result): MemoizedSelector<State, Result>;
