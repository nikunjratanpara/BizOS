CREATE FUNCTION DBO.GETINSERTWITHSELECTQUERY( @TABLENAME VARCHAR(50))
RETURNS VARCHAR(MAX)
AS
BEGIN
...
CREATE FUNCTION DBO.GETINSERTQUERY( @TABLENAME VARCHAR(50))
RETURNS VARCHAR(MAX)
AS
BEGIN
	DECLARE @COLUMNS VARCHAR(MAX) = '';
...
CREATE FUNCTION DBO.GETUPDATEQUERY(@TABLENAME VARCHAR(50))
RETURNS VARCHAR(MAX)
AS
BEGIN
	DECLARE @COLUMNS VARCHAR(MAX) = '';
...
CREATE FUNCTION DBO.GETOBJECTQUERY( @TABLENAME VARCHAR(50))
RETURNS VARCHAR(MAX)
AS
BEGIN
	DECLARE @COLUMNS VARCHAR(MAX) = '';
...
CREATE  FUNCTION DBO.GETDELETEQUERY( @TABLENAME VARCHAR(50))
RETURNS VARCHAR(MAX)
AS
BEGIN
	DECLARE @CONDITION VARCHAR(MAX)= '';
...
END
GO 
CREATE FUNCTION DBO.GETMARKROWASDELETEQUERY(@TABLENAME VARCHAR(50))
RETURNS VARCHAR(MAX)
AS
BEGIN
	DECLARE @CONDITION VARCHAR(MAX)= '';
